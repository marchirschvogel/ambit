...
class cardiovascular0Dsyspul_veins(cardiovascular0Dsyspul):
    ...
    def equation_map(self):
        ...
        self.x_[5] = q_ar_sys_
        self.x_[6] = p_ven_sys_
        self.x_[7] = q_ven1_sys_
        self.x_[8] = q_ven2_sys_
        self.x_[9+self.si[3]] = q_vin_r_
        self.x_[10-self.si[3]] = p_at1_r_
        self.x_[11+self.si[1]] = q_vout_r_
        self.x_[12-self.si[1]] = p_v_r_
        self.x_[13] = p_ar_pul_
        self.x_[14] = q_ar_pul_
        self.x_[15] = p_ven_pul_
        self.x_[16] = q_ven1_pul_
        self.x_[17] = q_ven2_pul_
        self.x_[18] = q_ven3_pul_
        self.x_[19] = q_ven4_pul_
        ...
        self.df_[5]  = (self.L_ar_sys/self.R_ar_sys) * q_ar_sys_
        self.df_[6]  = self.C_ven_sys * p_ven_sys_
        self.df_[7] = (L_ven1_sys/R_ven1_sys) * q_ven1_sys_
        self.df_[8] = (L_ven2_sys/R_ven2_sys) * q_ven2_sys_
                # -----------------------------------------------------------
        self.df_[9]  = VQ_at_r_ * self.switch_V[3]
        self.df_[10]  = 0.
        self.df_[11] = VQ_v_r_ * self.switch_V[1]
        self.df_[12] = 0.
        self.df_[13] = self.C_ar_pul * (p_ar_pul_ - self.Z_ar_pul * q_vout_r_)
        self.df_[14] = (self.L_ar_pul/self.R_ar_pul) * q_ar_pul_
        self.df_[15] = self.C_ven_pul * p_ven_pul_
        self.df_[16] = (L_ven1_pul/R_ven1_pul) * q_ven1_pul_
        self.df_[17] = (L_ven2_pul/R_ven2_pul) * q_ven2_pul_
        self.df_[18] = (L_ven3_pul/R_ven3_pul) * q_ven3_pul_
        self.df_[19] = (L_ven4_pul/R_ven4_pul) * q_ven4_pul_
        ...
        self.f_[4] = -q_vout_l_ + q_ar_sys_
        self.f_[5] = (p_ven_sys_ - p_ar_sys_ + self.Z_ar_sys * q_vout_l_)/self.R_ar_sys + q_ar_sys_
        self.f_[6] = -q_ar_sys_ + (q_ven1_sys_ + q_ven2_sys_)
        self.f_[7] = (p_at1_r_-p_ven_sys_)/R_ven1_sys + q_ven1_sys_
        self.f_[8] = (p_at2_r_-p_ven_sys_)/R_ven2_sys + q_ven2_sys_
                # -----------------------------------------------------------
        self.f_[9] = -(q_ven1_sys_ + q_ven2_sys_) + q_vin_r_ - (1-self.switch_V[3]) * VQ_at_r_
        self.f_[10] = (p_at_r_d_-p_v_r_)/R_vin_r_ - q_vin_r_
        self.f_[11] = -q_vin_r_ + q_vout_r_ - (1-self.switch_V[1]) * VQ_v_r_
        self.f_[12] = (p_v_r_d_-p_ar_pul_)/R_vout_r_ - q_vout_r_
        self.f_[13] = -q_vout_r_ + q_ar_pul_
        self.f_[14] = (p_ven_pul_ - p_ar_pul_ + self.Z_ar_pul * q_vout_r_)/self.R_ar_pul + q_ar_pul_
        self.f_[15] = -q_ar_pul_ + (q_ven1_pul_ + q_ven2_pul_ + q_ven3_pul_ + q_ven4_pul_)
        self.f_[16] = (p_at1_l_-p_ven_pul_)/R_ven1_pul + q_ven1_pul_
        self.f_[17] = (p_at2_l_-p_ven_pul_)/R_ven2_pul + q_ven2_pul_
        self.f_[18] = (p_at3_l_-p_ven_pul_)/R_ven3_pul + q_ven3_pul_
        self.f_[19] = (p_at4_l_-p_ven_pul_)/R_ven4_pul + q_ven4_pul_
        ...
        self.a_[8]  = 0.
                # -----------------------------------------------------------
        self.a_[9]  = VQ_at_r_ * (1-self.switch_p[3]) + p_at1_r_ * self.switch_p[3]
        self.a_[10]  = p_at_r_d_ * self.switch_p[3]
        self.a_[11] = VQ_v_r_ * (1-self.switch_p[1]) + p_v_r_ * self.switch_p[1]
        self.a_[12] = p_v_r_d_ * self.switch_p[1]
        self.a_[13] = self.C_ar_pul * (p_ar_pul_ - self.Z_ar_pul * q_vout_r_) + self.V_ar_pul_u
        self.a_[14] = 0.
        self.a_[15] = self.C_ven_pul * p_ven_pul_ + self.V_ven_pul_u
        self.a_[16] = 0.
        self.a_[17] = 0.
        self.a_[18] = 0.
        self.a_[19] = 0.
    ...
    def initialize(self, var, iniparam):
        ...
        var[5] = iniparam['q_ar_sys_0']
        var[6] = iniparam['p_ven_sys_0']
        var[7] = iniparam['q_ven1_sys_0']
        var[8] = iniparam['q_ven2_sys_0']
        var[9+self.si[3]] = iniparam['q_vin_r_0']
        var[10-self.si[3]] = iniparam[''+self.vname_prfx[3]+'_at_r_0']
        var[11+self.si[1]] = iniparam['q_vout_r_0']
        var[12-self.si[1]] = iniparam[''+self.vname_prfx[1]+'_v_r_0']
        var[13] = iniparam['p_ar_pul_0']
        var[14] = iniparam['q_ar_pul_0']
        var[15] = iniparam['p_ven_pul_0']
        var[16] = iniparam['q_ven1_pul_0']
        var[17] = iniparam['q_ven2_pul_0']
        var[18] = iniparam['q_ven3_pul_0']
        var[19] = iniparam['q_ven4_pul_0']
