...
class cardiovascular0Dsyspul(cardiovascular0Dbase):
    ...
    def equation_map(self):
        ...
        self.x_[8+self.vs-self.si[3]] = p_ati_r_[0]
        self.x_[9+self.vs+self.si[1]] = q_vout_r_
        self.x_[10+self.vs-self.si[1]] = p_vi1_r_
        ...
        self.f_[8+self.vs] = (p_ato1_r_-p_vi1_r_)/R_vin_r_ - q_vin_r_
        self.f_[9+self.vs] = -q_vin_r_ + q_vout_r_ - (1-self.switch_V[1]) * VQ_v_r_
        self.f_[10+self.vs] = (p_vo1_r_-p_ar_pul_)/R_vout_r_ - q_vout_r_
        ...
        for n in range(self.vp):
            self.f_[14+self.vs+n] = (p_ati_l_[n]-p_ven_pul_)/R_ven_pul[n] + q_ven_pul_[n]
        ...
        for n in range(self.vs):
            self.a_[7+n] = 0.
                # -----------------------------------------------------------
        self.a_[7+self.vs]  = VQ_at_r_ * (1-self.switch_p[3]) + p_ati_r_[0] * self.switch_p[3]
        self.a_[8+self.vs] = p_ato1_r_ * self.switch_p[3]
        self.a_[9+self.vs] = VQ_v_r_ * (1-self.switch_p[1]) + p_vi1_r_ * self.switch_p[1]
        self.a_[10+self.vs] = p_vo1_r_ * self.switch_p[1]
        self.a_[11+self.vs] = self.C_ar_pul * (p_ar_pul_ - self.Z_ar_pul * q_vout_r_) + self.V_ar_pul_u
        self.a_[12+self.vs] = 0.
        self.a_[13+self.vs] = self.C_ven_pul * p_ven_pul_ + self.V_ven_pul_u
        for n in range(self.vp):
            self.a_[14+self.vs+n] = 0.
    ...
    def print_to_screen(self, var, aux):
        ...
        if self.comm.rank == 0:
            ...
            print('{:<9s}{:<3s}{:<10.1f}{:<3s}{:<9s}{:<3s}{:<10.1f}'.format(''+self.cname_prfx[2]+'_at_l',' = ',aux[self.auxmap[''+self.cname_prfx[2]+'_at_l']],'   ',''+self.cname_prfx[3]+'_at_r',' = ',aux[self.auxmap[''+self.cname_prfx[3]+'_at_r']]))
            print('{:<9s}{:<3s}{:<10.1f}{:<3s}{:<9s}{:<3s}{:<10.1f}'.format(''+self.cname_prfx[0]+'_v_l',' = ',aux[self.auxmap[''+self.cname_prfx[0]+'_v_l']],'   ',''+self.cname_prfx[1]+'_v_r',' = ',aux[self.auxmap[''+self.cname_prfx[1]+'_v_r']]))
