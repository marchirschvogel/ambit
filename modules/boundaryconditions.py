...
class boundary_cond_solid(boundary_cond):
    ...
    def membranesurf_bcs(self, u, v, a, u_old, v_old, a_old):
        ...
        for m in self.bc_dict['membrane']:
            ...
            for i in range(len(m['id'])):
                ...
                w_old += self.vf.deltaW_ext_membrane(self.ki.F(u_old), self.ki.Fdot(v_old), a_old, m['params'], db_)
...
class boundary_cond_fluid(boundary_cond):
    ...
    # set membrane surface BCs
    def membranesurf_bcs(self, uf, v, a, uf_old, v_old, a_old):
        ...
        for m in self.bc_dict['membrane']:
            ...
            for i in range(len(m['id'])):
                ...
                w     += self.vf.deltaP_ext_membrane(self.ki.F(uf), self.ki.Fdot(v), a, m['params'], db_)
                w_old += self.vf.deltaP_ext_membrane(self.ki.F(uf_old), self.ki.Fdot(v_old), a_old, m['params'], db_)
            ...
            if r['type'] == 'spring':
                ...
                if r['dir'] == 'xyz':
                    ...
                    for i in range(len(r['id'])):
                        ...
                        w += self.vf.deltaW_ext_robin_spring(u, r['stiff'], db_)
                    ...
                    for i in range(len(r['id'])):
                        ...
                        w += self.vf.deltaW_ext_robin_spring_normal(u, r['stiff'], db_)
