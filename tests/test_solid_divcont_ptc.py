...
def test_main():
    ...
    CONTROL_PARAMS = {"maxtime": 1.0, "numstep": 10, "numstep_stop": 1}
    ...
    BC_DICT = {
        ...
        "neumann": [{"id": [loc1()], "dir": "xyz_ref", "curve": [0, 1, 1]}], # at x=1 - test version with locator; could also use "id":[3] instead
    }
