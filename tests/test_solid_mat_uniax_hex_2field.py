...
def test_main():
    ...
    CONTROL_PARAMS = {"maxtime": 1.0, "numstep": 1}
    ...
    def P_mr(lam):
        c1, c2 = (
            MATERIALS["MAT2"]["mooneyrivlin_dev"]["c1"],
            MATERIALS["MAT2"]["mooneyrivlin_dev"]["c2"],
        )
    ...
    def P_ho(lam):
        a_0, b_0 = (
            MATERIALS["MAT3"]["holzapfelogden_dev"]["a_0"],
            MATERIALS["MAT3"]["holzapfelogden_dev"]["b_0"],
        )
        a_f, b_f = (
            MATERIALS["MAT3"]["holzapfelogden_dev"]["a_f"],
            MATERIALS["MAT3"]["holzapfelogden_dev"]["b_f"],
        )
        a_s, b_s = (
            MATERIALS["MAT3"]["holzapfelogden_dev"]["a_s"],
            MATERIALS["MAT3"]["holzapfelogden_dev"]["b_s"],
        )
