...
def main():
    ...
    CONTROL_PARAMS = {"maxtime": 1.0, "numstep": 10, "numstep_stop": 10}
    ...
    TIME_PARAMS = {"timint": "static", "rho_inf_genalpha": 1.0}

    FEM_PARAMS = {"order_disp": 1, "quad_degree": 1, "incompressibility": "no"}
