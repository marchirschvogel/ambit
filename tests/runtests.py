...
if category == "fluid_multiphase" or category == "fluid" or category == "all":
    errs["test_fluid_multiphase_bdf2_rising_bubble 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_fluid_multiphase_bdf2_rising_bubble.py"]
    )
...
if category == "fluid_ale_multiphase" or category == "fluid_multiphase" or category == "fluid" or category == "all":
    ...
    errs["test_fluid_ale_multiphase_sloshing 3 restart"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_fluid_ale_multiphase_sloshing.py", str(4)]
    )

if category == "fsi" or category == "all":
    errs["test_fsi_taylorhood_artseg_fluidgov_neumann_neumann 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fsi_taylorhood_artseg_fluidgov_neumann_neumann.py"]
    )
    errs["test_fsi_taylorhood_artseg_fluidgov_neumann_neumann 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_fsi_taylorhood_artseg_fluidgov_neumann_neumann.py"]
    )

    errs["test_fsi_taylorhood_artseg_fluidgov_neumann_dirichlet 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_fsi_taylorhood_artseg_fluidgov_neumann_dirichlet.py"]
    )

    errs["test_fsi_p1p1_artseg_fluidgov_neumann_neumann 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fsi_p1p1_artseg_fluidgov_neumann_neumann.py"]
    )
    errs["test_fsi_p1p1_artseg_fluidgov_neumann_neumann 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_fsi_p1p1_artseg_fluidgov_neumann_neumann.py"]
    )
    errs["test_fsi_p1p1_artseg_fluidgov_neumann_neumann 2 restart"] = subprocess.call(
        [
            "mpiexec",
            "-n",
            "2",
            "python3",
            "test_fsi_p1p1_artseg_fluidgov_neumann_neumann.py",
            str(4),
        ]
    )
    errs["test_fsi_p1p1_artseg_fluidgov_neumann_dirichlet 2"] = subprocess.call(
        ["mpiexec", "-n", "2", "python3", "test_fsi_p1p1_artseg_fluidgov_neumann_dirichlet.py"]
    )
    errs["test_fsi_p1p1_tank2d_fluidgov_neumann_neumann 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fsi_p1p1_tank2d_fluidgov_neumann_neumann.py"]
    )
    errs["test_fsi_p1p1_tank2d_fluidgov_neumann_neumann 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_fsi_p1p1_tank2d_fluidgov_neumann_neumann.py"]
    )
    errs["test_fsi_p1p1_tank2d_solidgov_neumann_neumann 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_fsi_p1p1_tank2d_solidgov_neumann_neumann.py"]
    )
    errs["test_fsi_p1p1_tank2d_solidgov_neumann_neumann_slip 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_fsi_p1p1_tank2d_solidgov_neumann_neumann_slip.py"]
    )
    errs["test_fsi_p1p1_tank2d_fluidgov_neumann_dirichlet 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fsi_p1p1_tank2d_fluidgov_neumann_dirichlet.py"]
    )
    errs["test_fsi_p1p1_tank2d_fluidgov_neumann_dirichlet 3"] = subprocess.call(
        ["mpiexec", "-n", "3", "python3", "test_fsi_p1p1_tank2d_fluidgov_neumann_dirichlet.py"]
    )
    errs["test_fsi_taylorhood_tank2d_fluidgov_neumann_dirichlet_bgs3x3outer-s2x2 4"] = subprocess.call(
        ["mpiexec", "-n", "4", "python3", "test_fsi_taylorhood_tank2d_fluidgov_neumann_dirichlet_bgs3x3outer-s2x2.py"]
    )
    ...
    errs["test_fsi_p1p1_pipe_valve_fluidgov_neumann_neumann 1"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fsi_p1p1_pipe_valve_fluidgov_neumann_neumann.py"] # TODO: Fails in parallel!!!
    )

if category == "fsi" or category == "fsi_multiphase" or category == "all":
    errs["test_fsi_multiphase_elastocap_refine_fluidgov_neumann_dirichlet 2"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fsi_multiphase_elastocap_refine_fluidgov_neumann_dirichlet.py"]
    )
    errs["test_fsi_multiphase_elastocap_refine_fluidgov_neumann_dirichlet 2 restart"] = subprocess.call(
        ["mpiexec", "-n", "1", "python3", "test_fsi_multiphase_elastocap_refine_fluidgov_neumann_dirichlet.py", str(4)]
    )
    errs["test_fsi_multiphase_dambreak_fluidgov_neumann_neumann_bgs4x4-s2x2-s3x3 4"] = subprocess.call(
        ["mpiexec", "-n", "4", "python3", "test_fsi_multiphase_dambreak_fluidgov_neumann_neumann_bgs4x4-s2x2-s3x3.py"]
    )
...
if category == "solid_flow0d" or category == "all":
    ...
    errs["test_solid_flow0d_monodir_flux_syspulcap_3Dheart_s2x2 2"] = subprocess.call(
        [
            "mpiexec",
            "-n",
            "2",
            "python3",
            "test_solid_flow0d_monodir_flux_syspulcap_3Dheart_s2x2.py",
        ]
    )

    errs["test_solid_flow0d_monodir2field_flux_syspulcap_3Dheart_s3x3 4"] = subprocess.call(
        [
            "mpiexec",
            "-n",
            "4",
            "python3",
            "test_solid_flow0d_monodir2field_flux_syspulcap_3Dheart_s3x3.py",
        ]
    )
...
if category == "frsi" or category == "all":
    ...
    errs["test_frsi_artseg_prefile_partitioned_s3x3 4"] = subprocess.call(
        [
            "mpiexec",
            "-n",
            "4",
            "python3",
            "test_frsi_artseg_prefile_partitioned_s3x3.py",
        ]
    )
...
if category == "ale" or category == "all":
    ...
    errs["test_ale_oscillating_box_prescribed 2"] = subprocess.call(["mpiexec", "-n", "2", "python3", "test_ale_oscillating_box_prescribed.py"])
