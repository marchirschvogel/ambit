...
if category=='fluid' or category=='all':
    ...
    errs['test_fluid_constraint_flux_p1p1_stab_cylinder 3'] = subprocess.call(['mpiexec', '-n', '3', 'python3', 'test_fluid_constraint_flux_p1p1_stab_cylinder.py'])
...
if category=='frsi' or category=='fluid_ale' or category=='all':
    ...
    errs['test_frsi_artseg_prefile 2'] = subprocess.call(['mpiexec', '-n', '2', 'python3', 'test_frsi_artseg_prefile.py'])
    errs['test_frsi_artseg_prestress 3'] = subprocess.call(['mpiexec', '-n', '3', 'python3', 'test_frsi_artseg_prestress.py'])
    ...
    errs['test_frsi_artseg_constraint 2'] = subprocess.call(['mpiexec', '-n', '2', 'python3', 'test_frsi_artseg_constraint.py'])
