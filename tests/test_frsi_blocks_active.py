...
def test_main():
    ...
    CONTROL_PARAMS = {"maxtime": 0.3, "numstep": 50}

    ROM_PARAMS = {
        "modes_from_files": [basepath + "/input/blocks3_mode_*.xdmf"],
        "partitions": [
            basepath + "/input/blocks3_part-1.xdmf",
            basepath + "/input/blocks3_part-2.xdmf",
            basepath + "/input/blocks3_part-3.xdmf",
        ],
    ...
    COUPLING_PARAMS = {"coupling_fluid_ale": {"interface": [2, 8, 14]}}
        ...
        "membrane": [
            {
                ...
                "params": {
                    ...
                    "active_stress": {
                        ...
                        "iota": 0.333,
                        "gamma": 0.0,
                        "weight": basepath + "/input/blocks3_part-1.xdmf",
                    },
                },
            },
            {
