...
"""
Multiphase FSI simulation of a 2D tank with flexible, forced lid - Lagrange multiplier ("Neumann-Neumann") FSI formulation
"""
...
def test_main():
    ...
    IO_PARAMS = {
        ...
        "simname": "fsi_multiphase_neumann_neumann",
    }
    ...
    SOLVER_PARAMS = {
        ...
        "tol_inc": [1e-5, 1e-5, 1e-5, 1e-5, 1e-5, 1e-5, 1e-5],
    }
