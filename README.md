...
* Get latest tested ambit-compatible digest (4 Jun 2023) of dolfinx Docker image:

``docker pull dolfinx/dolfinx@sha256:3fda143d9cfd9790ab8e3a37d826699891d7e83b740bf007838ea8fc7290ac63``
...
``alias fenicsdocker='docker run -ti -v $HOME:/home/shared -v <PATH_TO_AMBIT_FOLDER>:/home/ambit -w /home/shared/ --env-file <PATH_TO_AMBIT_FOLDER>/.env.list --rm dolfinx/dolfinx@sha256:3fda143d9cfd9790ab8e3a37d826699891d7e83b740bf007838ea8fc7290ac63'``
