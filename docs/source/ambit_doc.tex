...
\end{align}
with $\tilde{\sigma}=\frac{3\sigma}{2\sqrt{2}}$ (surface energy density coefficient) and $\epsilon=0.64\,h_{\mathrm{e}}$, where $h_{\mathrm{e}}$ is the finite element edge length. Parameters for the two cases are shown in the following table. Bulk viscosities are assumed zero ($\zeta=0$).
