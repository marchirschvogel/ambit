...
\subsection{Solid}\label{subsec:demos_solid}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{fig/cantilever_setup.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{fig/cantilever_results.png}
\caption{Cantilever, tip deformation. Color shows displacement magnitude.}
\label{fig:cantilever_results}
\end{figure}


\subsection{Fluid}\label{subsec:demos_fluid}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{fig/channel_setup.png}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{fig/syspul_setup.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{fig/syspul_results.png}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{fig/heart_syspul_setup.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{fig/heart_syspul_results.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{fig/pipe_0d_setup.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth]{fig/pipe_0d_results.png}
