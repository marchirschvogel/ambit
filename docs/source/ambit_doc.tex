...
\begin{figure}
\centering
\includegraphics[width=0.85\textwidth]{fig/channel_setup.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.85\textwidth]{fig/channel_results.png}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{fig/syspul_setup.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{fig/syspul_results.png}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{fig/heart_syspul_setup.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{fig/heart_syspul_results.png}
