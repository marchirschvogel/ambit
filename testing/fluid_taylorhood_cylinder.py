...
def main():
    ...
    IO_PARAMS           = {'problem_type'          : 'fluid',
                           ...
                           'results_to_write'      : ['velocity','pressure','acceleration','cauchystress','reynolds','fluiddisplacement'],
    ...
    # problem setup
    problem = ambit.Ambit(IO_PARAMS, TIME_PARAMS_FLUID, SOLVER_PARAMS_FLUID, FEM_PARAMS, MATERIALS, BC_DICT, time_curves=time_curves())
